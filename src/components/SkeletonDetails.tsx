    ...
    <div className='max-w-4xl mx-auto p-4 animate-pulse'>
      ...
      <div className='bg-white p-6 rounded-b-xl shadow grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className='space-y-4'>
          <div className='h-5 w-24 bg-base-200 rounded mt-4'></div>

          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i}>
              <div className='h-3 w-1/2 bg-base-200 rounded mb-2'></div>
              <div className='h-2 w-full bg-base-200 rounded'></div>
            </div>
          ))}

          <div className='h-4 w-24 bg-base-200 rounded mt-6'></div>
